...
{"kind": "<kind>", "target_food": "<food name or empty>", "adjustment": <number or null>, "scope": "<scope>", "rationale": "<why>"}

Rules for "kind":
- "portion_adjust": the user says the amount of a food is wrong (too much / too little). Set "adjustment" to the multiplier to apply to the current grams (e.g. 0.5 if they ate half, 2.0 if they ate double). Set "target_food" to the food name.
